...
const brands = [
  ...
  },
  {
    ...
    description: [
      ...
      "Bisquit & Dubouché XO is a masterpiece of Cognac craftsmanship, offering an exceptional depth of flavor and an opulent sensory experience. This Extra Old (XO) cognac is meticulously crafted using the finest eaux-de-vie from the Grande and Petite Champagne crus, aged for a minimum of 10 years to achieve remarkable complexity and smoothness. It has a rich and complex aroma with notes of dried fruit, honey, cinnamon, and dark chocolate. A velvety texture with layers of ripe plum, hazelnut, and sweet spice, evolving into deep oak, leather undertones with a long, warm, and exceptionally smooth finish, leaving a lingering impression of elegance. Best enjoyed neat or with a drop of water to fully unveil its depth. An exquisite choice for those who appreciate refined luxury and timeless sophistication.",
    ],
  },
  {
